// From https://github.com/domaindrivendev/Ahoy
...
namespace Meceqs.AspNetCore.Swagger.SwaggerUi
{
    public class SwaggerUiMiddleware
    {
        ...
        public async Task Invoke(HttpContext httpContext)
        {
            ...
            var template = _resourceAssembly.GetManifestResourceStream("Meceqs.AspNetCore.Swagger.SwaggerUi.CustomAssets.index.html");
