...
namespace Meceqs.Sending
{
    public interface IMessageSender
    {
        ...
        /// This is can be used to forward an envelope from a consumer to a different sender.
        /// </summary>
        ...
        /// This is can be used to forward envelopes from a consumer to a different sender.
        /// </summary>
        ...
        /// <summary>
        /// Creates a builder that sends a list of <paramref name="message"/>s to a pipeline.
        /// <summary>
